...
* Project Path: ~;
* Project Name: data mining AA;
* Diagram Id: EMWS1;
* Diagram Name: AA;
* Generated by: u63454190;
* Date: 08JAN2024:09:42:10;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* Macro Variables;
*------------------------------------------------------------*;
...
id= "FIMPORT";
property="IFileName";
value= "D:\7005\AA\output_4_preprocessing Preparation.xlsx";
output;
id= "FIMPORT";
